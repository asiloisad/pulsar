...
class WorkspaceElement extends HTMLElement {
  ...
  updateGlobalTextEditorStyleSheet() {
    let fontSize = e.config.get('editor.fontSize')
    let fontFamily = e.config.get('editor.fontFamily')
    let lineHeight = e.config.get('editor.lineHeight')
    let absLineHeight = Math.round(fontSize*lineHeight)
    const styleSheetSource = `atom-workspace {
      --editor-font-size: ${fontSize}px;
      --editor-font-family: ${fontFamily};
      --editor-line-height: ${absLineHeight}px;
    }`;
